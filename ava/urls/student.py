...
urlpatterns = [
    ...
    path("tentativa/<int:tentativa_id>/comprovante/", student.baixar_comprovante_atividade, name="aluno_baixar_comprovante_atividade"),
    path("certificado/<int:certificado_id>/baixar/", student.baixar_certificado, name="aluno_baixar_certificado"),
